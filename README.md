...
|---|---|---|
| `SSH_HOST` | Hostname from `DOCKER_HOST` | Override the SSH connection target if it differs from the Docker API host. |
| `SSH_USER` | Current OS username | Override the SSH username. |
